...
description: "Produce a read-only repository grounding handoff for backend work without assuming a specific language stack."
---
...
- Output known facts, relevant paths, viable options, unresolved gaps, validation surfaces, and a concise handoff that the lock stage can cite.
- Separate confirmed facts from inference and recommendation; the lock stage may copy only confirmed facts and user-approved recommendations.
