...
| [Concepts](./docs/concepts.zh-CN.md) | 三层模型、编译器模型和阶段边界。 |
| [Workflow Contract](./docs/workflow-contract.zh-CN.md) | 阶段、权限、证据、验证和 proof。 |
| [Profile Schema](./docs/profile-schema.zh-CN.md) | 如何把团队准则维护成 YAML profile。 |
...
| [Examples](./docs/examples.zh-CN.md) | 端到端 workflow 示例。 |
