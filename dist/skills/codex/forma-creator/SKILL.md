...
This installed creator is fixed to the Codex target. Before writing generated plan-first skills, load `references/agent-target.md` and follow it as a hard output contract.
