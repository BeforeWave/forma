...
- If `Iteration Area` is `governance`, apply `governance` overlay constraint: Identify which governance surface changes: README.md, README.zh-CN.md, STRUCTURE.md, AGENTS.md, dist/AGENTS.md, profiles/forma-self, or plan-first workflow policy.
