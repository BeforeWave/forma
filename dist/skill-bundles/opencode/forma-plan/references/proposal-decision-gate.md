...
- Do not replace a user-required proof with a weaker surrogate, move it to post-commit/manual, or leave report/evidence paths for the lock stage to choose unless the user has explicitly accepted that boundary.
