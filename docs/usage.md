...
| Diagnose repo agent-operability | `forma doctor [path] --format human|agent|json` | Read-only check for agent entrypoints, source boundaries, validation contracts, task state, human gates, noise control, and optional agent integrations. |
